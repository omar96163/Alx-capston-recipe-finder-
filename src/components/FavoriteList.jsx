    ...
    <div className={`${darkmod && "dark"} font-serif`}>
      <div className="bg-[url('/Images/bg-w.webp')] dark:bg-[url('/Images/bg-b.avif')] bg-cover bg-center">
        <div className=" bg-white py-5 px-3 sm:px-16 bg-opacity-20 dark:bg-black dark:bg-opacity-70 min-h-screen max-h-full">
          ...
          <div className="lg:overflow-auto h-[280px]">
            {favlist.length > 0 ? (
              <div
              ...
              >
                {favlist.map((meal) => (
                  <div
                    key={meal.idMeal}
                    className="flex justify-between items-center lg:mx-4 my-2 p-4 
                    bg-white bg-opacity-40 rounded-md dark:bg-black 
                    dark:text-white hover:scale-105 transition dark:bg-opacity-40"
                  >
